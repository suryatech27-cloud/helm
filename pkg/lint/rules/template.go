...
func Templates(linter *support.Linter, values map[string]interface{}, namespace string, strict bool) {
	...
	// See https://github.com/suryatech27-cloud/helm/issues/9658
	...
	*/
	for _, template := range chart.Templates {
		...
		// NOTE: disabled for now, Refs https://github.com/suryatech27-cloud/helm/issues/1463
		...
		// NOTE: disabled for now, Refs https://github.com/suryatech27-cloud/helm/issues/1037
		...
		if strings.TrimSpace(renderedContent) != "" {
			...
			for {
				...
				if yamlStruct != nil {
					...
					// Refs https://github.com/suryatech27-cloud/helm/issues/8596
...
//
// See https://github.com/suryatech27-cloud/helm/issues/8467
...
// See https://github.com/suryatech27-cloud/helm/issues/1990
