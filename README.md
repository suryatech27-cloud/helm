...
Binary downloads of the Helm client can be found on [the Releases page](https://github.com/suryatech27-cloud/helm/releases/latest).
...
The [Helm roadmap uses GitHub milestones](https://github.com/suryatech27-cloud/helm/milestones) to track the progress of the project.
